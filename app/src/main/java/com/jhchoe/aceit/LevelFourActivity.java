...
public class LevelFourActivity extends Activity implements TextToSpeech.OnInitListener {
    ...
    public void startGame(View view) {
        ...
        TextView intr = (TextView) findViewById(R.id.instruction_four);
    ...
    private void initialize() {
        ...
        counterV = (TextView) findViewById(R.id.counter_four);
        counterV.setText(getCount());

        textB = (TextView) findViewById(R.id.voice_text_four);

        RelativeLayout lay = (RelativeLayout) findViewById(R.id.text_four);
